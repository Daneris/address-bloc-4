...
const sequelize = require("../db/models/index").sequelize;
 ...
 describe("ContactController", () => {
    ...
    describe("#getContacts()", () => {
      it("should return empty array when no contacts are available", (done) =>{
        this.book.getContacts()
          .then((contacts) =>{
            expect(contacts.length).toBe(0);
            done();
      ...
      it("should return an array of contacts when contacts are present", (done) =>{
        this.book.addContact("Alice","484-869-4499", "alice123@gmail.com")
          .then(() =>{
            this.book.getContacts()
              .then((contacts) =>{
              console.log(contacts, "logging contacts alice")
                expect(contacts.length).toBe(1);
                done();
              });
          })
             ...
             .then(() =>{
               this.book.getContacts()
                 .then((contacts) =>{
                   ...
                   console.log(contact, "logging contact Magus johnson")
